    ...
    <footer id="contact" className="bg-black text-white py-16">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          {/* Company */}
          <div>
            <h3 className="text-xl font-bold mb-4" style={{ color: "#6B1C95" }}>
              Company
            </h3>
          ...
          <div className="max-w-md mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              <input
                ...
                style={{ "--focus-border": "#6B1C95" }}
                onFocus={(e) => (e.currentTarget.style.borderColor = "#6B1C95")}
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-gray-400 text-sm">
              Copyright © {new Date().getFullYear()} Alaqa. All rights reserved.
            </div>
            <div className="flex space-x-4">
              <a
                href="#"
                className="text-gray-400 transition-colors"
                onMouseEnter={(e) => (e.currentTarget.style.color = "#6B1C95")}
